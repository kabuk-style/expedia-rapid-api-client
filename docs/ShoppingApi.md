...
> <Array(<Array<GetAdditionalAvailability200ResponseInner>>, Integer, Hash)> get_additional_availability_with_http_info(accept, accept_encoding, user_agent, property_id, token, opts)
...
begin
  ...
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<GetAdditionalAvailability200ResponseInner>>
rescue ExpediaRapid::ApiError => e
