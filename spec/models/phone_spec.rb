...
# Unit tests for ExpediaRapid::Phone
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ExpediaRapid::Phone do
  let(:instance) { ExpediaRapid::Phone.new }

  describe 'test an instance of Phone' do
    it 'should create an instance of Phone' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(ExpediaRapid::Phone)
    end
  end
