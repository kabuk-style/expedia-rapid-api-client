...
module ExpediaRapid
  ...
  class GetPropertyContent200ResponseValueRatingsGuest
    ...
    attr_accessor :recommendation_percent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ExpediaRapid::GetPropertyContent200ResponseValueRatingsGuest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ExpediaRapid::GetPropertyContent200ResponseValueRatingsGuest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'recommendation_percent')
        self.recommendation_percent = attributes[:'recommendation_percent']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          recommendation_percent == o.recommendation_percent
    end
    ...
    def hash
      [count, overall, cleanliness, service, comfort, condition, location, neighborhood, quality, value, amenities, recommendation_percent].hash
    end
